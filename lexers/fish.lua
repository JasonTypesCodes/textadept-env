...
local keyword = token(l.KEYWORD, word_match{
  ...
  'fish_prompt', 'fish_right_prompt', 'fish_update_completions', 'fishd', 
  'for', 'funced', 'funcsave', 'function', 'functions', 'help', 'history', 
  'if', 'in', 'isatty', 'jobs', 'math', 'mimedb', 'nextd', 'not', 'open', 'or', 'popd',
  'prevd', 'psub', 'pushd', 'pwd', 'random', 'read', 'return', 'set', 'set_color',
  'source', 'status', 'switch', 'test', 'trap', 'type', 'ulimit', 'umask', 
  'vared', 'while'
})
...
M._tokenstyles = {shebang = l.STYLE_LABEL}
...
M._foldsymbols = {
  _patterns = {'%l+'},
  [l.KEYWORD] = {
    begin = 1, ['for'] = 1, ['function'] = 1, ['if'] = 1, switch = 1, ['while'] = 1, ['end'] = -1
  }
}
